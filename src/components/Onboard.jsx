...
//   // Only one box per section, no boxes for field headings
...
//   // Helper for dynamic marks placeholder
//   const getMarksPlaceholder = (section) =>
//     markTypes[section] === "percentage" ? "Percentage" : "CGPA";
...
//           <h4 className="main-section-heading">Name</h4>
//           <input
//             type="text"
//             name="name"
...
//           <h4 className="main-section-heading">Parent's Name</h4>
//           <input
//             type="text"
//             name="parentName"
...
//           <h4 className="main-section-heading">
...
//         {/* Special side-by-side layout for tenth, intermediate, diploma */}
//         {["tenth", "intermediate", "diploma"].includes(key) ? (
...
//             <div className={`edu-grid-item ${!isDegree ? "edu-grid-full" : ""}`}>
//               <div className="mark-type-label">{marksLabel}</div>
//               <input
//                 type="text"
//                 placeholder={marksLabel}
